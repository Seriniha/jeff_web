...
<head>
    ...
    <link rel="stylesheet" href="css/"> <!-- Make sure to include the correct CSS file -->
...
<div class="container page_border"> 
    <h1 style="text-align:center; margin-top:10px; font-size:70px; font-family:Algerian; color:black">Kashimo's peripheral</h1>
    <div class="vertical-rectangle"></div>
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Algerian; color:black">peripheral Menu</h1>
                ...
                <div class="row">
                    <script>
                        const peripheralItems = [
                            { name: "camera1", price: 1099 },
                            { name: "keyboard1", price: 499 },
                            { name: "keyboard2", price: 1199 },
                            { name: "keyboard3", price: 1299 },
                            { name: "keyboard4", price: 899 },
                            { name: "keyboard5", price: 1499 },
                            { name: "keyboard6", price: 1099 },
                            { name: "monitor1", price: 999 },
                            { name: "monitor2", price: 2099 },
                            { name: "monitor3", price: 899 },
                            { name: "monitor4", price: 799 },
                            { name: "mouse1", price: 499 },
                            { name: "mouse2", price: 1099 },
                            { name: "mouse3", price: 1099 },
                            { name: "mouse4", price: 1099 },
                            { name: "mouse5", price: 1099 },
                            { name: "mouse6", price: 999 },
                            { name: "printer1", price: 1199 },
                            { name: "printer2", price: 699 },
                            { name: "printer3", price: 999 }
                        ];

                        for (let i = 0; i < peripheralItems.length; i++) {
                            const item = peripheralItems[i];
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="peripheral_images/${i + 1}.png" data-toggle="tooltip" data-placement="center" title="peripheral" width="170" height="180" alt="${item.name}">
                                        <div>
