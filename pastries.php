...
<head>
    ...
    <link rel="stylesheet" href="css/pastries.css"> <!-- Make sure to include the correct CSS file -->
    <script src="js/pastries.js"></script>

</head>
<style>
    body {
    background-image: url('bgimage/pastrybg.jpg');
...
<div class="container page_border"> 
    <h1 style="text-align:center; margin-top:10px; font-size:70px; font-family:Algerian; color:black">Kashimo's Pastry</h1>
    <div class="vertical-rectangle"></div>
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Algerian; color:black">Pastry Menu</h1>
                ...
                <div class="options-column" id="optionsColumn">
                    <ul class="options-list">
                        <li class="options-list-item"><a href="burgers.php">Burgers</a></li>
                ...
                <div class="row">
                    <script>
                        const pastryItems = [
                            { name: "Choco-chip cookie", price: 50 },
                            { name: "Churros", price: 49 },
                            { name: "Creme Breulle", price: 119 },
                            { name: "Croissant", price: 129 },
                            { name: "Croquembouche", price: 89 },
                            { name: "Eclair", price: 149 },
                            { name: "Kouign Amann", price: 109 },
                            { name: "Macaroons", price: 99 },
                            { name: "Madeleines", price: 209 },
                            { name: "Mille Feuilles", price: 89 },
                            { name: "Pain Aux Raisins", price: 79 },
                            { name: "Pain Au Chocolat", price: 49 },
                            { name: "Palmier", price: 109 },
                            { name: "Paris-brest", price: 109 },
                            { name: "Profiteroles", price: 109 },
                            { name: "Religieuse", price: 109 },
                            { name: "Quiche bacon and egg", price: 99 },
                            { name: "Quiche egg tart", price: 119 },
                            { name: "Strawberry crepe", price: 69 },
                            { name: "Strawberry tart", price: 99 }
                        ];

                        for (let i = 0; i < pastryItems.length; i++) {
                            const item = pastryItems[i];
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="Pastry_images/${i + 1}.png" data-toggle="tooltip" data-placement="center" title="pastry" width="170" height="180" alt="${item.name}">
                                        <div>
