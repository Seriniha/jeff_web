...
<head>
    ...
    <link rel="stylesheet" href="css/soda.css"> <!-- Make sure to include the correct CSS file -->
...
<div class="container page_border"> 
    <h1 style="text-align:center; margin-top:10px; font-size:70px; font-family:Algerian; color:black">Kashimo's Soda</h1>
    <div class="vertical-rectangle"></div>
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Algerian; color:black">Soda Menu</h1>
                ...
                <div class="row">
                    <script>
                        const sodaItems = [
                            { name: "7up", price: 15 },
                            { name: "a&w", price: 20 },
                            { name: "canada dry", price: 25 },
                            { name: "coca cola", price: 17 },
                            { name: "coke vanilla", price: 25 },
                            { name: "coke zero", price: 20 },
                            { name: "crush orange", price: 18 },
                            { name: "crush grape", price: 16 },
                            { name: "dr pepper", price: 35 },
                            { name: "fanta", price: 36 },
                            { name: "irn bru", price: 40 },
                            { name: "monster", price: 27 },
                            { name: "mountain dew", price: 22 },
                            { name: "sunkist", price: 26 },
                            { name: "pepsi blue", price: 24 },
                            { name: "pepsi", price: 31 },
                            { name: "pibb", price: 19 },
                            { name: "rc cola", price: 20 },
                            { name: "redbull", price: 69 },
                            { name: "sprite", price: 25 }
                        ];

                        for (let i = 0; i < sodaItems.length; i++) {
                            const item = sodaItems[i];
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="soda_images/${i + 1}.png" data-toggle="tooltip" data-placement="center" title="soda" width="170" height="180" alt="${item.name}">
                                        <div>
